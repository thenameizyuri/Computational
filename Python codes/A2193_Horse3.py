# -*- coding: utf-8 -*-
"""
Created on Wed Jun  4 07:33:33 2025
...
# Load data
data = pd.read_csv("Python codes/A2199_Horse4.csv.csv")  # Assumes headers exist
...
initial_guess = [4.08e-7, 870]  # [beta, b]
...
t_eval = np.linspace(0, 40, 500)  # High resolution for smooth plot
sol_fit = solve_ivp(
...
plt.title(' Horse A2193', fontsize = 20)
