...
# Load data
data = pd.read_csv("Python codes/A2245_Horse1.csv")  # Assumes headers exist
...
initial_guess = [0.94e-7, 2124]  # [beta, b]
...
plt.title('Viral Dynamics Fit - Horse A2245', fontsize = 20)
